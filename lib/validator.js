...
var Validator = {
	...
	getInverse: function(fn) {

		return inverse[fn] || null
...
Validator.toString = validator.toString
Validator.toDate = validator.toDate
Validator.toFloat = validator.toFloat
Validator.toInt = validator.toInt
Validator.toBoolean = validator.toBoolean
