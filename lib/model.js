...
var Model = function(fields, options, modeler) {
...
_.extend(Model.prototype, {
	...
	build: function(data, options) {
		...
		var instance = new Instance(this, data, options, this.modeler)
	...
	addHook: function(type, name, fn) {

		// Will remove the 'name' argument once migrated away from sequelize.
		// !!!
